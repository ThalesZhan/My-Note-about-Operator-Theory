...
\end{defn}
\begin{rem}
	In fact, the normal homomorphsims are postive linear maps that is continuous with respect to the $SOT$. In particular, if $E \in \A$, $A \mapsto EAE$ is a normal homomorphism.
\end{rem}
